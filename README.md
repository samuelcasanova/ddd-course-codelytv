...
<div align="center">
  ...
  <h3 align="center">Domain Driven Design Course Repository</h3>
</div>

<!-- ABOUT THE PROJECT -->
## About The Project

This educational project is the practicing part of the DDD Course from CodelyTV Pro. This project starts from the end of the Microservice Architecture course in this repo: git@github.com:samuelcasanova/microservices-course-codelytv.git
...
1. Clone the repo
   ```sh
   git clone git@github.com:samuelcasanova/ddd-course-codelytv.git
   ```
...
Project Link: [https://github.com/samuelcasanova/ddd-course-codelytv](git@github.com:samuelcasanova/ddd-course-codelytv.git)
