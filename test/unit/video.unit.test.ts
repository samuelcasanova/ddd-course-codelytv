import { CreateVideoCommand } from '../../src/contexts/mooc/courses/video/application/CreateVideoCommand'
import { CreateVideoCommandHandler } from '../../src/contexts/mooc/courses/video/application/CreateVideoCommandHandler'
import { Video } from '../../src/contexts/mooc/courses/video/domain/Video'
import { SearchAllVideosQueryHandler } from '../../src/contexts/mooc/courses/video/application/SearchAllVideosQueryHandler'
import type { EventBus, EventSubscriber } from '../../src/contexts/mooc/courses/shared/domain/EventBus'
import { SearchAllVideosQuery } from '../../src/contexts/mooc/courses/video/application/SearchAllVideosQuery'
import type { VideosResponse } from '../../src/contexts/mooc/courses/video/application/VideosResponse'
import type { Event } from '../../src/contexts/mooc/courses/shared/domain/Event'
import { UpdateVideoScoreCommand } from '../../src/contexts/mooc/courses/video/application/UpdateVideoScoreCommand'
import { UpdateVideoScoreCommandHandler } from '../../src/contexts/mooc/courses/video/application/UpdateVideoScoreCommandHandler'
import { VideoAlreadyExistsError } from '../../src/contexts/mooc/courses/video/application/VideoAlreadyExistsError'
import { InMemoryCacheRepository } from '../../src/contexts/mooc/courses/shared/infrastructure/InMemoryCacheRepository'
